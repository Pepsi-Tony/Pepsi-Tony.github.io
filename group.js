...
function win(){
    document.getElementById('bsg').style.display = 'inherit';
...
function lm(){
    var c = prompt('Who do you want to know ?(1 is Novak Djokovic, 2 is Li Na)');
    switch(c){
        case '1':
            alert('Djokovic himself is a fan of Red Star Belgrade, AC Milan and Sporting Clubs Lisbon and Benfica in Portugal. Therefore, when there is no game, Djokovic often plays with these football players');
            break;
        case '2':
            alert('Li Na belongs to the type with relatively strong attack power among Chinese and even Asian tennis players. Due to his outstanding upper body strength, compared with other Asian players, he can play a more threatening baseline attack. From the point of view of batting style, Li Na belongs to the offensive bottom line stalemate style of play. In the game, the forehand and backhand are often used to hit the fast return ball that is closer to the bottom line and the sideline, so that the opponent is passive. Its backhand is once known as the world top level');
            break;
        default:
            alert('error')
    }
...
let mb = document.getElementById("b1");
function gotop() {
